 ...
 */
public class ReviewTabsAdapter extends FragmentPagerAdapter implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener{
    /**
    ...
    /* Constructor */
    public ReviewTabsAdapter(FragmentActivity activity, TabHost tabHost, ViewPager pager) {
        this(activity, activity.getSupportFragmentManager(), tabHost, pager);
    }

    public ReviewTabsAdapter(Context context, FragmentManager fragmentManager, TabHost tabHost, ViewPager pager) {
