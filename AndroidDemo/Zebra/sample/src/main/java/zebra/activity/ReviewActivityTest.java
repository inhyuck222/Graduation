...
public class ReviewActivityTest extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getFragmentManager().beginTransaction().add(R.id.container, new ReviewFragment()).commit();
        }
    }

    public void pushSignUpFragment() {
        getFragmentManager().beginTransaction().replace(R.id.container, new ReviewFragment()).addToBackStack(null).commit();
    }

    public void pushLogInFragment() {
        getFragmentManager().beginTransaction().replace(R.id.container, new ReviewRegisterFragment()).addToBackStack(null).commit();
    }
